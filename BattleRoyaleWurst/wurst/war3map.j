...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'n01W', 1297.2, 19448.7, 307.419)
    ...
    set u=CreateUnit(p, 'n02H', 16538.8, 14910.7, 285.574)
    ...
    set u=CreateUnit(p, 'n01L', 18091.4, 891.5, 243.318)
    set u=CreateUnit(p, 'n01L', 20857.8, 280.7, 2.977)
    set u=CreateUnit(p, 'n01L', 23331.1, 3020.2, 248.630)
    set u=CreateUnit(p, 'n01L', 21137.1, 3262.6, 273.579)
    ...
    set u=CreateUnit(p, 'n02L', 11268.7, 10383.1, 286.155)
    ...
    set u=CreateUnit(p, 'n01Y', 8123.5, 17562.4, 282.268)
    ...
    set u=CreateUnit(p, 'n025', 6890.2, 17391.0, 325.032)
    ...
    set u=CreateUnit(p, 'n01B', 17551.4, 20152.8, 279.178)
    set u=CreateUnit(p, 'n004', 27921.4, 6917.0, 354.474)
    set u=CreateUnit(p, 'n01B', 16408.8, 25539.6, 52.055)
    set u=CreateUnit(p, 'n002', 16018.7, 22206.1, 273.420)
    ...
    set u=CreateUnit(p, 'n00J', 15689.1, 12311.9, 293.039)
    ...
    set u=CreateUnit(p, 'n01U', 25795.1, 26146.3, 283.131)
    ...
    set u=CreateUnit(p, 'n01Y', 710.1, 17409.5, 286.495)
    set u=CreateUnit(p, 'n01Y', 9001.7, 22609.3, 289.720)
    ...
    set u=CreateUnit(p, 'n01J', 7147.1, 11613.5, 315.652)
    set u=CreateUnit(p, 'n01J', 5512.2, 11516.4, 102.637)
    set u=CreateUnit(p, 'n01J', 5425.5, 10077.4, 286.402)
    set u=CreateUnit(p, 'n01J', 6149.6, 9183.3, 331.700)
    ...
    set u=CreateUnit(p, 'n01J', 7827.9, 10133.9, 273.890)
    ...
    set u=CreateUnit(p, 'n01B', 13948.3, 23656.5, 314.800)
    set u=CreateUnit(p, 'n01B', 20125.1, 22445.3, 326.300)
    ...
    set u=CreateUnit(p, 'n003', 28261.1, 21914.5, 288.892)
    ...
    set u=CreateUnit(p, 'n01O', 17865.8, 3940.4, 307.826)
    ...
    set u=CreateUnit(p, 'n01X', 9255.1, 22474.8, 318.524)
    ...
    set u=CreateUnit(p, 'n026', 6787.9, 17354.0, 286.867)
    ...
    set u=CreateUnit(p, 'n02B', 17675.7, 6532.3, 242.340)
    set u=CreateUnit(p, 'n02C', 17413.1, 6668.5, 207.747)
    set u=CreateUnit(p, 'n02C', 17530.0, 6354.2, 287.477)
endfunction
