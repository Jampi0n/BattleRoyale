...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'n00A', 12141.6, 28237.3, 322.645)
    ...
    set u=CreateUnit(p, 'n00A', 12656.7, 20730.1, 279.369)
    set u=CreateUnit(p, 'n00A', 12705.9, 20424.0, 162.680)
    set u=CreateUnit(p, 'n00A', 14067.4, 7347.9, 17.161)
    set u=CreateUnit(p, 'n00A', 14057.6, 7838.1, 342.575)
